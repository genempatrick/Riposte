...
def listener_mdns(server_ip):
    ...
    print(f"Listening on {server_ip}:5353")
    while True:
        ...
        print(now.strftime('%Y-%m-%d %H:%M:%S'), "[MDNS]: Request from", address, "for hostname", hostname_parsed, "received.")
